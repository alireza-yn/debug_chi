  ...
  return (
    <main>
      <div className="relative">
        <Hero
          header="بهترین کلاس های عمومی متناسب با نیازت"
          button_title="درخواست کلاس فوری"
          url="/community/chat"
          description="موضوعی که بهش علاقه داری رو انتخاب کن"
          description_2="تا کلاس هارو بهت نمایش بدم"
        />
      ...
      >
        <Services
          ...
          title_placement="justify-start"
        />
      </section>

      <ClassInfo data={data} title={"کلاس های عمومی پر"} highlight="مخاطب" />
      ...
      >
        <Services
          data={service_2}
          title="موضوعات پردآمد"
          title_placement="justify-start"
        />
      </section>
      <OnlineDebugers data={cards} button_title={"درخواست مشاوره"} />
    </main>
  );
};

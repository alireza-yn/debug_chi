...
const Video = (props: Props) => {
  return (
    <div className="max-w-screen-2xl mx-auto flex flex-col items-center justify-center min-h-[500px]  dark:bg-slate-900 box-border p-5">
      ...
      <div className="w-full h-[600px] mt-4 relative flex items-center justify-center ">
        <Image
          ...
          alt="ai"
          objectFit="cover"
          className="opacity-80 hover:opacity-100 rounded-2xl"
          fill
        />
        <Button className="w-36 h-36 absolute z-40" variant="light" size="lg">
          <Play />
        </Button>
      </div>
    </div>

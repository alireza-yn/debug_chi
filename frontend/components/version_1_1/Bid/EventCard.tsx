...
export default function EventCard({ data }: { data: Project }) {
  const { isOpen, onOpen, onOpenChange } = useDisclosure()
  const [selecetdImage, setSelectedImage] = useState<string>(data.images[0].image)
  ...
  return (
    <>
      <Button
        className="absolute right-0 bottom-0 bg-default-100/60"
        radius="full"
        endContent={
                ...
                <div className="flex flex-col gap-2 w-full justify-center items-center pt-4">
                  ...
                  <div className="w-full justify-center items-center flex gap-2">
                    {data.images
                      ...
                      .slice(0, 4)}
                    <Button startContent={<Ellipsis />} variant="light" size="sm" isIconOnly></Button>
                  </div>
                </div>
                <div className="flex flex-col gap-2 py-4">
                  <h1 className="text-2xl font-bold leading-7">{data.class_title}</h1>
                  ...
                  <div className="mt-4 flex flex-col gap-3">
                    <div className="flex gap-3 items-center">
                      ...
                      <div className="flex flex-col gap-0.5">
                        <p className="text-medium text-foreground font-medium">زمان برگزاری کلاس</p>
                    ...
                    <div className="flex gap-3 items-center">
                      ...
                      <div className="flex flex-col gap-0.5">
                        ...
                        <p className="text-small text-default-500">گوگل میت Google Meet</p>
                      </div>
                    </div>
                    <div className="flex flex-col mt-4 gap-3 items-start">
                      <span className="text-medium font-medium">درباره کلاس</span>
                      <p className="text-sm leading-relaxed text-default-600 whitespace-pre-line">{data.description}</p>
                      <div className="text-medium text-default-500 flex flex-col gap-2">
                        ...
                        <Button
                          ...
                          variant="faded"
                          as={Link}
                          href={`${process.env.server}/${data.educational_heading_file}`}
                        >
                          دانلود سرفصل
                        </Button>
                        <p className="mt-4">
                    ...
                    <div className="flex flex-col mt-4 gap-3 items-start">
                      ...
                      <div className="flex gap-2 items-center">
                        <Avatar name="HeroUI" size="sm" src="https://heroui.com/android-chrome-192x192.png" />

              ...
              <DrawerBody className="pt-16" dir="rtl">
                <div className="flex flex-col gap-2 w-full justify-center items-center pt-4">
                  <Image
                    ...
                    height={300}
                    src={`${process.env.server}/${selecetdImage}`}
                  />
                  ...
                  <div className="mt-4 flex flex-col gap-3">
                    ...
                    <div className="flex flex-col mt-4 gap-3 items-start">
                      ...
                      <div className="text-medium text-default-500 flex flex-col gap-2">
                        ...
                        <Button size="sm" className="w-2/4 my-2"  color="secondary"   startContent={<Download size={14} />} variant="faded" as={Link} href={`${process.env.server}/${data.educational_heading_file}`}>دانلود سرفصل</Button>
                        <p className="mt-4">

    ...
    <div className="w-full mx-auto h-full flex flex-col items-center justify-center p-4">
      ...
      >
        ...
        <div className="flex flex-col items-center justify-center gap-4">
          ...
          <p>در نهایت، مشکل برنامه نویسی شما حل شدنیه! با ما همراه باشید تا بدون دردسر، سریع و دقیق، مشکل شما را بررسی و حل کنیم
            <br />
            <br />
        ...
        <div className="my-8">
          <p className="text-gray-600 mb-4">لطفاً برای شروع پاسخگویی به سوالات روی دکمه زیر کلیک کنید.</p>

          <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
            <Button variant="solid" color="secondary" className="w-full py-3" onPress={() => setStarted(true)}>
              شروع
            </Button>
          </motion.div>
        </div>

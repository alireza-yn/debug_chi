...
import { setAnalyze, setConversation } from '@/redux/slices/aiSlice';
...
const SendDescription = (props: Props) => {
    const {is_last_question} = useAppSelector((state:RootState)=>state.aiQuestion)
